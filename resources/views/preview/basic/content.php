<div class="growtype-post-single-inner">
    ...
    <div class="b-content">
        ...
        if (!empty($terms)) { ?>
            <p class="e-terms" data-terms="<?php echo strtolower($terms) ?>"><?php echo $terms ?></p>
        <?php } ?>
        ...
        <?php echo growtype_post_render_social_cta($post->ID); ?>
    </div>

    <?php if (get_theme_mod('growtype_post_preview_continue_actions_enabled', true)) { ?>
        <div class="b-actions">
